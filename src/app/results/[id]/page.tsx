...
import { CheckCircle, XCircle, ChevronDown, ChevronUp, Home, RotateCcw } from "lucide-react"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 32 }}>
        {answers.map((a, i) => (
          <div
            ...
            style={{
              background: "var(--card)",
              border: `1px solid ${a.isCorrect ? "rgba(67,217,138,0.3)" : "rgba(239,68,68,0.3)"}`,
              borderRadius: 12,
              overflow: "hidden",
            }}
          >
            ...
            >
              ...
              {expanded === a.id ? <ChevronUp size={16} color="var(--muted)" /> : <ChevronDown size={16} color="var(--muted)" />}
            </button>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        marginBottom: 6,
                        fontSize: 14,
                        background: isCorrect ? "rgba(67,217,138,0.1)" : isUserAnswer && !isCorrect ? "rgba(239,68,68,0.1)" : "transparent",
