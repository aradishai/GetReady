...
export default function TestPage() {
  ...
  async function submitTest() {
    ...
    const res = await fetch("/api/results", {
      ...
      body: JSON.stringify({
        courseId: questions[0] ? "demo" : undefined,
    ...
    return (
      <div style={{ maxWidth: 540, margin: "0 auto", padding: "40px 16px" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <ClipboardList size={48} color="var(--accent)" style={{ marginBottom: 12 }} />
        ...
        >
              ...
              {[10, 20, 30].map((n) => (
                <button
                  ...
                  style={{
                    ...
                    background: config.count === n ? "rgba(108,99,255,0.15)" : "transparent",
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    background: config.sourceType === value ? "rgba(108,99,255,0.15)" : "transparent",
          ...
          <div style={{ marginBottom: 28 }}>
            <label
              style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", fontWeight: 600 }}
            >
              <input
                type="checkbox"
                ...
                {[15, 30, 60].map((t) => (
                  <button
                    ...
                    style={{
                      ...
                      background: config.timePerQ === t ? "rgba(255,209,102,0.1)" : "transparent",
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
          <span style={{ color: "var(--muted)", fontSize: 13 }}>
            ענית על {answered}/{questions.length}
          </span>
          {config.timed && (
            <span
              style={{
                ...
                alignItems: "center",
                gap: 5,
                color: timeLeft <= 10 ? "var(--danger)" : "var(--warning)",
                fontWeight: 700,
                fontSize: 16,
              }}
            >
          ...
          {answersObj.map(({ key, label, text }) => (
            <button
              ...
              style={{
                ...
                background: answers[current] === key ? "rgba(108,99,255,0.15)" : "var(--card)",
            ...
            >
              <span
                style={{
                  ...
                  height: 28,
                  borderRadius: "50%",
                  background: answers[current] === key ? "var(--primary)" : "var(--card-border)",
                  display: "flex",
                  alignItems: "center",
      ...
      <div style={{ display: "flex", justifyContent: "space-between", gap: 10 }}>
        <button
          ...
          style={{
            ...
            border: "1px solid var(--card-border)",
            background: "var(--card)",
            color: current === 0 ? "var(--muted)" : "var(--foreground)",
        ...
        {questions.map((_, i) => (
          <button
            ...
            style={{
              ...
              background: i === current ? "var(--primary)" : answers[i] ? "rgba(67,217,138,0.15)" : "var(--card)",
              color: "#fff",
              cursor: "pointer",
              fontSize: 11,
              fontWeight: 600,
