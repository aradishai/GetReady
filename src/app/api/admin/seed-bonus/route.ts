...
const BONUS_QUESTIONS = [
  ...
  },
  {
    ...
    answerB: "האם קיים דיאלוג בין הדמויות ומה אופיו",
    answerC: "האם הנבדק מזהה את כל הדמויות המופיעות בתמונה",
    answerD: "עד כמה הסיפור מתרחש באופן ריאלי",
    correctAnswer: "B",
    explanation: "",
    position: 6,
  },
  ...
  },
  {
    ...
    answerB: "מפני שהיא פתוחה יותר לפרשנות ומעוררת מגוון אפשרויות",
    answerC: "מפני שהיא מייצגת בהכרח את הנבדק",
  ...
  },
  {
    ...
    answerA: "הסיפור משקף קושי בקבלת סמכות הורית",
    answerB: "הסיפור עשוי להעיד על תפיסה של קשרים מנותקים והיעדר דיאלוג",
  ...
  },
  {
    ...
    answerB: "יחסים בין דוריים סביב היפרדות והשלמה",
    answerC: "צורך בהישגיות ובהכרה חברתית",
    answerD: "ציות לדמויות סמכות במשפחה",
    correctAnswer: "B",
    explanation: "",
    position: 10,
  },
